export const STRINGS = {
  intro: {
    welcomeTexts: [
      ...
      { text: "The Ultimate Fest Awaits!", icon: "Sparkles" },
    ],
  },
  journey: {
    title: "Journey Route",
    ...
    sections: [
      {
        ...
        content: "Join fellow tech enthusiasts on an exciting train journey from Bhubaneswar to IIT Madras for Paradox 2025!",
      },
      {
        title: "What's Included",
        items: [
          "20+ hours journey with tech discussions",
